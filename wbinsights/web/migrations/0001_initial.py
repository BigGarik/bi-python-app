    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cat', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, related_name='article', to='web.category')),
            ],
            options={
                'ordering': ['-time_create'],
                'indexes': [models.Index(fields=['-time_create'], name='web_article_time_cr_49d4ed_idx')],
            },
        ),
    ]
